...
/**
 * Defines the translation handler for entries.
 */
class EntryTranslationHandler extends ContentTranslationHandler {
  ...
  /**
   * Form submission handler for EntryTranslationHandler::entityFormAlter().
   *
